// =========================================================================
// DATA: MODULAR SLEDS, LICENSES, POWER SUPPLIES, OPTICS & DACS
// =========================================================================
...
Object.assign(MODULAR_UPLINK_CATALOG, {
  // Cisco Catalyst 9300 & 9300X Sleds
...
Object.assign(FEATURE_LICENSE_CATALOG, {
  // Ruckus ICX FastIron Feature Licenses (From Official Support KB 000006815)
  "ICX7850-PREM-LIC": { sku: "ICX7850-PREM-LIC", name: "Ruckus ICX 7850 Layer 3 Premium Software License (BGP, VRF-Lite)", msrp: 4500, category: "switch_feature" },
  ...
  // Allied Telesis Feature Licenses (Perpetual Keys - AW+ 5.5.6-1)
...
Object.assign(MGMT_SUBSCRIPTION_CATALOG, {
  "Meraki": {
    ...
    // Meraki does NOT have a $0 Standalone CLI profile; licenses are mandatory
  },
  "Ruckus": {
    // Official RUCKUS One device-agnostic subscription SKUs (Part 800-73413-001)
    "ruckus_one_prof": {
    ...
    // Official SmartZone Switch Management RTU License (Data Sheet PA-114067.11-EN)
    "smartzone": {
  ...
  "UniFi": {
    "free_central": {
      name: "UniFi OS (Free On-Prem / Cloud Controller / $0)",
...
Object.assign(POWER_SUPPLY_CATALOG, {
  // Redundant AC Power Supply Modules for Enterprise Modular Switches
  "PWR-C1-1100WAC-P": { sku: "PWR-C1-1100WAC-P", name: "Cisco 1100W AC Platinum Power Supply (Catalyst 9300)", msrp: 1200, category: "internal_psu" },
  "PWR-C1-715WAC-P": { sku: "PWR-C1-715WAC-P", name: "Cisco 715W AC Platinum Power Supply (Catalyst 9300)", msrp: 850, category: "internal_psu" },
  "JPSU-920-AC-AFI": { sku: "JPSU-920-AC-AFI", name: "Juniper 920W AC Redundant Power Supply (EX4400)", msrp: 950, category: "internal_psu" },
  "RPS23-E": { sku: "RPS23-E", name: "Ruckus 1000W AC Redundant Power Supply (ICX 7650 / 8200)", msrp: 850, category: "internal_psu" },
  "AT-PWR800": { sku: "AT-PWR800-80", name: "Allied Telesis 800W AC Redundant Power Supply (x530 Series)", msrp: 750, category: "internal_psu" },

  // Hardened Industrial Vendor Power Modules
  "JPSU-H-340W-E-AC": { sku: "JPSU-H-340W-E-AC", name: "Juniper 340W External Hardened AC Power Supply (EX4100-H-12MP)", msrp: 650, category: "external_brick" },
  "JPSU-H-340W-AC": { sku: "JPSU-H-340W-AC", name: "Juniper 340W Internal Hardened AC Power Supply (EX4100-H-24MP)", msrp: 750, category: "internal_hardened" },
  "AT-PWR300": { sku: "AT-PWR300-30", name: "Allied Telesis 300W External Power Supply (x320 / GS980EM)", msrp: 380, category: "external_brick" },

  // Standard Hardened Industrial DIN Rail Power Supplies (AC to 48-56VDC)
  "AMGPSU-148-P240A": { sku: "AMGPSU-148-P240A", name: "AMG 240W Industrial DIN Rail Power Supply (48-56VDC)", msrp: 260, category: "din_psu" },
  "AMGPSU-148-P480A": { sku: "AMGPSU-148-P480A", name: "AMG 480W Industrial High-Power DIN Rail Power Supply (48-56VDC)", msrp: 420, category: "din_psu" },
  "USP-RPS": { sku: "USP-RPS", name: "UniFi SmartPower Redundant DC Power System (Multi-Chassis)", msrp: 399, category: "dc_rps" }
});

// ==========================================
// 5. OPTICAL TRANSCEIVERS, DACS & STACKING
// ==========================================
OPTICS_LIST.push(
  // Cisco Meraki & Catalyst Transceivers & Cables
  ...
  { vendor: "Meraki", sku: "MA-CBL-TA-1M", name: "Meraki 10G Direct Attach Copper Cable (1m)", speed: "10G", speedRank: 10, formFactor: "DAC", medium: "DAC", msrp: 120, industrial: false },
  ...
  { vendor: "Meraki", sku: "SFP-H25G-CU1M", name: "Cisco 25G Direct Attach Copper Cable (1m)", speed: "25G", speedRank: 25, formFactor: "DAC", medium: "DAC", msrp: 195, industrial: false },
  { vendor: "Meraki", sku: "STACK-T1-50CM", name: "Cisco StackWise-1T Stacking Cable (0.5m)", speed: "1000G", speedRank: 1000, formFactor: "Stacking", medium: "Hardware", msrp: 250, industrial: false },
  { vendor: "Meraki", sku: "STACK-T4-50CM", name: "Cisco StackWise-80 Stacking Cable (0.5m)", speed: "80G", speedRank: 80, formFactor: "Stacking", medium: "Hardware", msrp: 180, industrial: false },
  ...
  { vendor: "Meraki", sku: "MA-CBL-40G-1M", name: "Meraki 40G Direct Attach Copper Cable (1m)", speed: "40G", speedRank: 40, formFactor: "DAC", medium: "DAC", msrp: 280, industrial: false },
  ...
  { vendor: "Meraki", sku: "QSFP-100G-CU1M", name: "Cisco 100G Direct Attach Copper Cable (1m)", speed: "100G", speedRank: 100, formFactor: "DAC", medium: "DAC", msrp: 340, industrial: false },

  // Ruckus CommScope Transceivers & Cables
  ...
  { vendor: "Ruckus", sku: "10G-SFPP-TWX-0101", name: "Ruckus 10G Direct Attach Copper Cable (1m)", speed: "10G", speedRank: 10, formFactor: "DAC", medium: "DAC", msrp: 95, industrial: false },
  ...
  { vendor: "Ruckus", sku: "25G-SFP28-TWX-0101", name: "Ruckus 25G Direct Attach Copper Cable (1m)", speed: "25G", speedRank: 25, formFactor: "DAC", medium: "DAC", msrp: 160, industrial: false },
  ...
  { vendor: "Ruckus", sku: "100G-QSFP28-TWX-0101", name: "Ruckus 100G Direct Attach Copper Cable (1m)", speed: "100G", speedRank: 100, formFactor: "DAC", medium: "DAC", msrp: 290, industrial: false },

  // Juniper Networks Transceivers & Cables
  ...
  { vendor: "Juniper", sku: "EX-SFP-10GE-DAC-1M", name: "Juniper 10G Direct Attach Copper (1m)", speed: "10G", speedRank: 10, formFactor: "DAC", medium: "DAC", msrp: 110, industrial: false },
  ...
  { vendor: "Juniper", sku: "JNP-25G-DAC-1M", name: "Juniper 25G Direct Attach Copper (1m)", speed: "25G", speedRank: 25, formFactor: "DAC", medium: "DAC", msrp: 175, industrial: false },
  ...
  { vendor: "Juniper", sku: "JNP-100G-DAC-1M", name: "Juniper 100G Direct Attach Copper (1m)", speed: "100G", speedRank: 100, formFactor: "DAC", medium: "DAC", msrp: 310, industrial: false },

  // Ubiquiti UniFi Transceivers & Cables
  { vendor: "UniFi", sku: "UACC-OM-MM-1G-D", name: "UniFi 1G Multi-Mode SFP (2-Pack)", speed: "1G", speedRank: 1, formFactor: "SFP", medium: "MMF", msrp: 38, industrial: false },
  { vendor: "UniFi", sku: "UACC-OM-SM-1G-D", name: "UniFi 1G Single-Mode SFP (2-Pack)", speed: "1G", speedRank: 1, formFactor: "SFP", medium: "SMF", msrp: 45, industrial: false },
  { vendor: "UniFi", sku: "UACC-OM-MM-10G-D", name: "UniFi 10G Multi-Mode SFP+ (2-Pack)", speed: "10G", speedRank: 10, formFactor: "SFP+", medium: "MMF", msrp: 76, industrial: false },
  { vendor: "UniFi", sku: "UACC-OM-SM-10G-D", name: "UniFi 10G Single-Mode SFP+ (2-Pack)", speed: "10G", speedRank: 10, formFactor: "SFP+", medium: "SMF", msrp: 95, industrial: false },
  { vendor: "UniFi", sku: "UACC-DAC-SFP10-1M", name: "UniFi 10G Direct Attach Cable (1m)", speed: "10G", speedRank: 10, formFactor: "DAC", medium: "DAC", msrp: 25, industrial: false },
  { vendor: "UniFi", sku: "UACC-OM-MM-25G-D", name: "UniFi 25G Multi-Mode SFP28 (2-Pack)", speed: "25G", speedRank: 25, formFactor: "SFP28", medium: "MMF", msrp: 120, industrial: false },
  { vendor: "UniFi", sku: "UACC-DAC-SFP28-1M", name: "UniFi 25G Direct Attach Cable (1m)", speed: "25G", speedRank: 25, formFactor: "DAC", medium: "DAC", msrp: 39, industrial: false },
  { vendor: "UniFi", sku: "UACC-OM-MM-100G-D", name: "UniFi 100G Multi-Mode QSFP28", speed: "100G", speedRank: 100, formFactor: "QSFP28", medium: "MMF", msrp: 299, industrial: false },
  { vendor: "UniFi", sku: "UACC-DAC-QSFP28-1M", name: "UniFi 100G Direct Attach Cable (1m)", speed: "100G", speedRank: 100, formFactor: "DAC", medium: "DAC", msrp: 89, industrial: false },

  // AMG Systems Hardened Industrial Optics (-40°C to +85°C)
  ...
  { vendor: "AMG", sku: "AMG-DAC-10G-1M", name: "AMG Industrial 10G DAC Cable (1m)", speed: "10G", speedRank: 10, formFactor: "DAC", medium: "DAC", msrp: 85, industrial: true },

  // Allied Telesis Optics & Direct Attach Cables
  ...
  { vendor: "Allied Telesis", sku: "AT-SP10TW1", name: "Allied Telesis 10G Direct Attach Cable (1m)", speed: "10G", speedRank: 10, formFactor: "DAC", medium: "DAC", msrp: 95, industrial: false },
  { vendor: "Allied Telesis", sku: "AT-SP10TW3", name: "Allied Telesis 10G Direct Attach Cable (3m)", speed: "10G", speedRank: 10, formFactor: "DAC", medium: "DAC", msrp: 140, industrial: false },
  ...
  { vendor: "Allied Telesis", sku: "AT-QSFP28-1CU", name: "Allied Telesis 100G Direct Attach Cable (1m)", speed: "100G", speedRank: 100, formFactor: "DAC", medium: "DAC", msrp: 290, industrial: false }
);
...
Object.assign(OPTICS_CATALOG, {
  "Meraki": {
    "1G": {
      "mmf": { sku: "MA-SFP-1GB-SX", name: "Meraki 1G Multi-Mode SFP (SX)", msrp: 230 },
      "smf": { sku: "MA-SFP-1GB-LX", name: "Meraki 1G Single-Mode SFP (LX)", msrp: 450 },
      "dac": null
    },
    "10G": {
      "mmf": { sku: "MA-SFP-10GB-SR", name: "Meraki 10G Multi-Mode SFP+ (SR)", msrp: 750 },
      "smf": { sku: "MA-SFP-10GB-LR", name: "Meraki 10G Single-Mode SFP+ (LR)", msrp: 1400 },
      "dac": { sku: "MA-CBL-TA-1M", name: "Meraki 10G Direct Attach Copper (1m)", msrp: 120 }
    },
    "25G": {
      "mmf": { sku: "SFP-25G-SR-S", name: "Cisco 25G Multi-Mode SFP28 (SR)", msrp: 1100 },
      "smf": { sku: "SFP-25G-LR-S", name: "Cisco 25G Single-Mode SFP28 (LR)", msrp: 2200 },
      "dac": { sku: "SFP-H25G-CU1M", name: "Cisco 25G Direct Attach Copper (1m)", msrp: 195 }
    },
    "40G": {
      "mmf": { sku: "MA-QSFP-40G-SR4", name: "Meraki 40G Multi-Mode QSFP+ (SR4)", msrp: 1900 },
      "smf": null,
      "dac": { sku: "MA-CBL-40G-1M", name: "Meraki 40G Direct Attach Copper (1m)", msrp: 280 }
    },
    "100G": {
      "mmf": { sku: "QSFP-100G-SR4-S", name: "Cisco 100G Multi-Mode QSFP28 (SR4)", msrp: 2900 },
      "smf": null,
  ...
  "Ruckus": {
    "1G": {
      "mmf": { sku: "E1MG-SX-OM", name: "Ruckus 1G Multi-Mode SFP (SX)", msrp: 180 },
      "smf": { sku: "E1MG-LX-OM", name: "Ruckus 1G Single-Mode SFP (LX)", msrp: 350 },
      "dac": null
    },
    "10G": {
      "mmf": { sku: "10G-SFPP-SR", name: "Ruckus 10G Multi-Mode SFP+ (SR)", msrp: 550 },
      "smf": { sku: "10G-SFPP-LR", name: "Ruckus 10G Single-Mode SFP+ (LR)", msrp: 1100 },
      "dac": { sku: "10G-SFPP-TWX-0101", name: "Ruckus 10G Direct Attach Copper (1m)", msrp: 95 }
    },
    "25G": {
      "mmf": { sku: "25G-SFP28-SR", name: "Ruckus 25G Multi-Mode SFP28 (SR)", msrp: 850 },
      "smf": null,
      "dac": { sku: "25G-SFP28-TWX-0101", name: "Ruckus 25G Direct Attach Copper (1m)", msrp: 160 }
    },
    "40G": {
      "mmf": { sku: "40G-QSFP-SR4", name: "Ruckus 40G Multi-Mode QSFP+ (SR4)", msrp: 1400 },
      "smf": null,
      "dac": null
    },
    "100G": {
      "mmf": { sku: "100G-QSFP28-SR4", name: "Ruckus 100G Multi-Mode QSFP28 (SR4)", msrp: 2200 },
      "smf": { sku: "100G-QSFP28-LR4", name: "Ruckus 100G Single-Mode QSFP28 (LR4, 10km)", msrp: 3950 },
      "dac": { sku: "100G-QSFP28-TWX-0101", name: "Ruckus 100G Direct Attach Copper (1m)", msrp: 290 }
    }
  },
  "Juniper": {
    "1G": {
      "mmf": { sku: "EX-SFP-1GE-SX", name: "Juniper 1G Multi-Mode SFP (SX)", msrp: 195 },
      "smf": { sku: "EX-SFP-1GE-LX", name: "Juniper 1G Single-Mode SFP (LX)", msrp: 380 },
      "dac": null
    },
    "10G": {
      "mmf": { sku: "EX-SFP-10GE-SR", name: "Juniper 10G Multi-Mode SFP+ (SR)", msrp: 620 },
      "smf": { sku: "EX-SFP-10GE-LR", name: "Juniper 10G Single-Mode SFP+ (LR)", msrp: 1250 },
      "dac": { sku: "EX-SFP-10GE-DAC-1M", name: "Juniper 10G Direct Attach Copper (1m)", msrp: 110 }
    },
    "25G": {
      "mmf": { sku: "SFP-25G-SR", name: "Juniper 25G Multi-Mode SFP28 (SR)", msrp: 920 },
      "smf": null,
      "dac": { sku: "JNP-25G-DAC-1M", name: "Juniper 25G Direct Attach Copper (1m)", msrp: 175 }
    },
    "40G": { "mmf": null, "smf": null, "dac": null },
    "100G": {
      "mmf": { sku: "JNP-QSFP-100G-SR4", name: "Juniper 100G Multi-Mode QSFP28 (SR4)", msrp: 2400 },
      "smf": { sku: "JNP-QSFP-100G-LR4", name: "Juniper 100G Single-Mode QSFP28 (LR4, 10km)", msrp: 4200 },
      "dac": { sku: "JNP-100G-DAC-1M", name: "Juniper 100G Direct Attach Copper (1m)", msrp: 310 }
    }
  },
  "UniFi": {
    "1G": {
      "mmf": { sku: "UACC-OM-MM-1G-D", name: "UniFi 1G Multi-Mode SFP (2-Pack)", msrp: 38 },
      "smf": { sku: "UACC-OM-SM-1G-D", name: "UniFi 1G Single-Mode SFP (2-Pack)", msrp: 45 },
      "dac": null
    },
    "10G": {
      "mmf": { sku: "UACC-OM-MM-10G-D", name: "UniFi 10G Multi-Mode SFP+ (2-Pack)", msrp: 76 },
      "smf": { sku: "UACC-OM-SM-10G-D", name: "UniFi 10G Single-Mode SFP+ (2-Pack)", msrp: 95 },
      "dac": { sku: "UACC-DAC-SFP10-1M", name: "UniFi 10G Direct Attach Cable (1m)", msrp: 25 }
    },
    "25G": {
      "mmf": { sku: "UACC-OM-MM-25G-D", name: "UniFi 25G Multi-Mode SFP28 (2-Pack)", msrp: 120 },
      "smf": null,
  ...
  "AMG": {
    ...
    "25G": { "mmf": null, "smf": null, "dac": null },
    "40G": { "mmf": null, "smf": null, "dac": null },
    "100G": { "mmf": null, "smf": null, "dac": null }
  },
  "Allied Telesis": {
    "1G": {
      "mmf": { sku: "AT-SPSX", name: "Allied Telesis 1G Multi-Mode SFP (SX)", msrp: 160 },
      "smf": { sku: "AT-SPLX10", name: "Allied Telesis 1G Single-Mode SFP (LX)", msrp: 280 },
      "dac": null
    },
    "10G": {
      "mmf": { sku: "AT-SP10SR", name: "Allied Telesis 10G Multi-Mode SFP+ (SR)", msrp: 490 },
      "smf": { sku: "AT-SP10LR", name: "Allied Telesis 10G Single-Mode SFP+ (LR)", msrp: 980 },
    ...
    "100G": {
      ...
      "smf": { sku: "AT-QSFP100-LR4", name: "Allied Telesis 100G Single-Mode QSFP28 (LR4)", msrp: 4100 },
